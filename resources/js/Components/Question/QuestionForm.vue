    ...
    <form @submit.prevent="submit">
        <div class="row mb-3">
            <div class="col-7">
                ...
                <div class="invalid-feedback" v-if="form.errors.title" v-text="form.errors.title" />
            </div>
            <div class="col-5">
        ...
        <div class="mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="write" role="tabpanel" aria-labelledby="write-tab"
                            ...
                            <textarea rows="7" class="form-control" :class="{ 'is-invalid': form.errors.body }"
                                v-model="form.body" name="body"></textarea>
                        </div>
                    ...
                    <div class="invalid-feedback" v-if="form.errors.body" v-text="form.errors.body" />
